...
public class DataFactory {
    ...
    public static final String[][][] criteriaAndBands = {{
...

        {
            {
                "Response",
                    "Response: Rigorous, lucid, creative",
                    "Response: question is very effectively addressed",
                    "Response: question is fully addressed ",
                    "Response: question is partially addressed",
                    "Minimal response to the task.",
                    "Minimal response to the task. ",
                    "Fails to address the general scope of the title",
                    "No attempt at task; evidence of cheating"
            },
            {
                "Understanding",
                    "N/A",
                    "Understanding: concepts/ issue/theories clearly understood",
                    "Understanding: concepts/issue/theories mostly clearly understood",
                    "Understanding: some evidence of issues/theories raised in course",
                    "Some inaccurate or muddled understanding of issues/theories",
                    "Mostly inaccurate understanding of issue or theory",
                    "Focus can be perceived only with difficulty.",
                    "No attempt at task; evidence of cheating; memorised script"
            },
            {
